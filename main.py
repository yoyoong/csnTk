...
class HelpMessage():
    ...
    inputFile = "input gene expression file, .gz format"
    gene1 = "the first input gene name list, txt format, one gene name per line"
    gene2 = "the second input gene name list, txt format, one gene name per line"
    sampleID = "input sample ID list, txt format, one sample ID per line"
...
if __name__ == '__main__':
    ...
    gw.add_argument('--tag', type=str, required=True, help=help.sampleID)
